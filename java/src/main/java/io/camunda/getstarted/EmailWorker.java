    ...
    try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
      client.newWorker().jobType("email").handler((jobClient, job) -> {
        ...
        jobClient.newCompleteCommand(job.getKey()).send()
          ...
          // So the following code leverages reactive programming instead. This is discssed in https://blog.bernd-ruecker.com/writing-good-workers-for-camunda-cloud-61d322cad862
